...
namespace JUTPS.CharacterBrain
{
    ...
    public class JUCharacterBrain : MonoBehaviour
    {
        ...
        public struct JUCharacterEvents
        {
            ...
            public UnityEvent OnDeath, OnRessurect, OnRun, OnStartRun, OnEndRun, OnSprinting, OnRoll, OnJump, OnCrouch, OnGetUp, OnStartMoving, OnIdle, OnEnterFireMode, OnExitFireMode, OnPunch;
            ...
            {
                if (isRunning != juchar.IsRunning)
                {
                    isRunning = juchar.IsRunning;
                    if (isRunning)
                    {
                        OnStartRun.Invoke();
                    }
        ...
        {
            SwitchItems(SwitchDirection.Forward, RightHand);
        }
        public void SwitchToPreviousItem(bool RightHand = true)
        {
            SwitchItems(SwitchDirection.Backward, RightHand);
        }
        ...
        public virtual void SwitchItems(SwitchDirection Direction, bool RightHand = true)
        {
            //Disable Aiming State and Shot State
            IsAiming = false; UsedItem = false;
