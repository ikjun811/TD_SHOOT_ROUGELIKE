        ...
        public void InstantiatePrefab()
        {
            ...
            else
            {
                ...
                for (int i = 0; i < Quantity; i++)
                {
                    ...
                    int idToInstantiate = Random.Range(0, PrefabsToInstantiate.Length);
                    GameObject prefab = PrefabsToInstantiate[idToInstantiate];
                    ...
                    GameObject new_instance = Instantiate(prefab, randomPosOnArea + PositionOffset, RandomRotation ? Quaternion.Euler(0, Random.Range(-360, 360), 0) : PrefabsToInstantiate[idToInstantiate].transform.rotation);
